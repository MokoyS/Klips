...
<body>
    ...
    <nav class="navbar">
        <a href="home.html" class="logo">KLIPS</a>
        <div class="nav-links">
            <ul>
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="centerform">
                <h1 class='bonjour'>Bonjour <?php echo $_SESSION['pseudo'] ?></h1>
                <form action="deco.php">
                    <button class="btn firt" type="submit"> Déconnexion </button>
                </form>
                    
                <h3 class='vosposts'>Vos posts :</h3>
            </div>
            <div class="zone-post">
                <div class="post">
                    ...
                    $r = $bdd->query("SELECT * FROM post WHERE pseudo = '$_SESSION[pseudo]'");
                    
                    ?>
                    <?php
                        foreach($r as $message):?>
                        <article class="<?php echo $message['tag']; ?>">
                            <div class="post-top">
